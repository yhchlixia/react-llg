  ...
  return (
    <div className="laboratory">
      <div style={{display: 'flex'}}>
        ...
        <div className="rotate" style={{width: 200, height: 200, backgroundColor: 'red', transform: 'rotate(45deg)'}}>
          <div style={{ width: 144, height: 144,fontSize: 34,margin: '0 auto', transform: 'rotate(-45deg)', wordBreak: 'break-all', backgroundColor: 'blue'}}>yhchlalalalalala</div>
        </div>
